			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="includes/signup.inc.php" method="post">
                    ...
                    <div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="uname" placeholder="Enter Full Name">
					...
					<div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="uid" placeholder="Username"  id="user"  onblur="userAvailability()">
						...
						<div class="wrap-input100 validate-input" >
						<input class="input100" type="email" name="email" placeholder="Email" id="email" onblur="emailAvailability()">
